                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" required
                                ...
                                <option value="confirmed" {{ old('status') === 'confirmed' ? 'selected' : '' }}>Confirmada
                                </option>
                                <option value="completed" {{ old('status') === 'completed' ? 'selected' : '' }}>Completada
                                </option>
                                <option value="cancelled" {{ old('status') === 'cancelled' ? 'selected' : '' }}>Cancelada
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="customer_notes" rows="3"
                                class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg">{{ old('customer_notes') }}</textarea>
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Notas Internas</label>
                            <textarea name="admin_notes" rows="3"
                                class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg">{{ old('admin_notes') }}</textarea>
                        </div>
                    </div>
