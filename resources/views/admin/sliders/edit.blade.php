                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 @enderror">{{ old('description', $slider->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <label for="image" class="block text-sm font-medium text-gray-700">
                                    {{ $slider->image ? 'Cambiar Imagen' : 'Imagen del Slider *' }}
                                </label>
                            ...
                            <div>
                                ...
                                <input type="text" name="button_text" id="button_text" value="{{ old('button_text', $slider->button_text) }}" placeholder="Ej: Ver más"
                            ...
                            <div>
                                ...
                                <input type="url" name="button_link" id="button_link" value="{{ old('button_link', $slider->button_link) }}" placeholder="https://ejemplo.com"
                            ...
                            <div>
                                ...
                                <select name="text_position" id="text_position" required
                                    ...
                                    <option value="left" {{ old('text_position', $slider->text_position) === 'left' ? 'selected' : '' }}>Izquierda</option>
                                    <option value="center" {{ old('text_position', $slider->text_position) === 'center' ? 'selected' : '' }}>Centro</option>
                                    <option value="right" {{ old('text_position', $slider->text_position) === 'right' ? 'selected' : '' }}>Derecha</option>
                                </select>
                                @error('text_position')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="text_color" id="text_color" required
                                    ...
                                    <option value="dark" {{ old('text_color', $slider->text_color) === 'dark' ? 'selected' : '' }}>Oscuro</option>
                                    <option value="light" {{ old('text_color', $slider->text_color) === 'light' ? 'selected' : '' }}>Claro</option>
                                </select>
