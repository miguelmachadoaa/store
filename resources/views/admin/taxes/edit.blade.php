                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.taxes.update', $tax) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="rate" id="rate" value="{{ old('rate', $tax->rate) }}"
                                required min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            @error('rate')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            <label for="is_active" class="flex items-center">
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $tax->is_active) ? 'checked' : '' }}
