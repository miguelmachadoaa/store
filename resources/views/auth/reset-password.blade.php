                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    required
                                    autocomplete="new-password"
                                    class="w-full px-3 py-2 bg-[#FAFAFA] border border-[#D5D9D9] rounded-[4px] text-sm text-[#0F1111] placeholder-[#B0B0B0] focus:outline-none focus:border-[#FFC933] focus:ring-1 focus:ring-[#FFC933] transition duration-150 @error('password_confirmation') border-[#B12704] focus:ring-[#B12704] @enderror"
                                >
                            </div>
                        </div>
