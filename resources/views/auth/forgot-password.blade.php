        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-[#14161d] border border-[#262b36] rounded-sm shadow-2xl overflow-hidden">
                ...
                <div class="px-8 pt-10 pb-10">
                    ...
                    {{-- Formulario --}}
                    <form method="POST" action="{{ route('password.email') }}" class="space-y-5 font-mono">
                        @csrf
            ...
            <div class="mt-6 flex items-center justify-center gap-5 text-[10px] text-gray-500 font-mono uppercase tracking-wider">
                <span class="flex items-center gap-1.5"><span class="text-blue-500">■</span> RECOVERY_MODE</span>
                <span class="flex items-center gap-1.5"><span class="text-blue-500">■</span> MAIL_GATEWAY</span>
            </div>
