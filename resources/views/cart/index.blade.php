    ...
    <section class="max-w-7xl mx-auto py-12 px-6">
        ...
        @if(count($cart) > 0)
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Price (USD)</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @php 
                            $total = 0;
                            // Obtenemos la tasa del día, esto es temporal para la vista, idealmente se pasa desde controlador
                        ...
                        @foreach($cart as $id => $item)
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-600">Bs. {{ number_format(($item['price'] * $item['quantity']) * $rate, 2) }}</div>
                                </td>
                        ...
                        <tr class="font-bold bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-gray-500 mt-1 font-normal">Tasa de cambio: Bs. {{ number_format($rate, 2) }}</div>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>
            ...
            <div class="mt-6 text-right">
                <a href="{{ route('checkout.index') }}" class="bg-indigo-600 text-white px-6 py-3 rounded-lg shadow hover:bg-indigo-700 font-bold">
                    Proceed to Checkout / Proceder al Pago
                </a>
            </div>
        @else
            <div class="text-center py-12">
                <p class="text-gray-500 text-lg">Your cart is empty / Tu carrito está vacío.</p>
